namespace WinFormsApp1
{
    partial class AboutBox1
    {
        ...
        private void InitializeComponent()
        {
            ...
            labelProductName.Text = "製品名 None";
            ...
            labelVersion.Text = "バージョン v1.2 Beta";
            ...
            labelCopyright.Text = "著作権 ゆっくりFred (ykfred_699)";
            ...
            textBoxDescription.Text = "本ソフトウェアはMIL Licence に基づき、本ソフトウェアは無保証で提供されます。\r\n著作権者およびライセンス保持者の許可なく、本ソフトウェアを改変・複製・再配布することは、著作権侵害にあたる場合があります。必ずライセンスの定める範囲内でご利用ください。\r\n© 2025 ゆっくりFred (ykfred_699) All Rights Reserved.";
            // 
            // okButton
            // 
